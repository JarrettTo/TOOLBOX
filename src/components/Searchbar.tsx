        ...
        <div className="fixed inset-x-0 top-0">
            ...
            <div className="bg-navbar-white border py-2">
                <div className="container max-w-7xl mx-auto flex items-center justify-between gap-2">
                    ...
                    {/* Search bar */}
                    <div className="searchdiv bg-[#D9D9D9]">
                        <button
                            className="btn btn-sm bg-orange hover:bg-orange-hover font-['SourceSansProBold'] text-10 text-black-pearl border-none">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512" className="size-3">
                            <path
